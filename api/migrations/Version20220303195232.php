 ...
 */
final class Version20220303195232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media_object (id INT NOT NULL, file_path VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, category VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE page (id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, route VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE page_item (id INT NOT NULL, page_id INT DEFAULT NULL, sort INT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_98DF39C4C4663E4 ON page_item (page_id)');
        $this->addSql('CREATE TABLE "section" (id INT NOT NULL, name VARCHAR(255) NOT NULL, from_age INT DEFAULT NULL, to_age INT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE text_item (id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, text TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, nickname VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_item_media_object DROP CONSTRAINT FK_49DBE73B64DE5A5');
        ...
        $this->addSql('ALTER TABLE image_item DROP CONSTRAINT FK_ED21CF80BF396750');
