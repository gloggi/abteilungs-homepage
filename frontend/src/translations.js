export const messages = {
  de: {
    dashboard: {
      ...
      fontWeightH1: "Schriftdicke Überschrift 1",
      fontWeightH2: "Schriftdicke Überschrift 2",
      fontWeightH3: "Schriftdicke Überschrift 3",
      ...
      tryAdjustingSearch:
        "Versuche, deine Suche anzupassen oder lade eine neue Datei hoch.",
      ...
      saving: "Speichert...",
      dragItemsHere: "Ziehe Elemente hierher",
      ...
      notifications: {
        success: "Erfolg",
        error: "Fehler",
        created: "{name} erfolgreich erstellt",
        updated: "{name} erfolgreich aktualisiert",
        deleted: "{name} erfolgreich gelöscht",
        duplicated: "{name} erfolgreich dupliziert",
        synced: "{name} erfolgreich synchronisiert",
        uploaded: "{name} erfolgreich hochgeladen",
        createError: "Fehler beim Erstellen von {name}",
        updateError: "Fehler beim Aktualisieren von {name}",
        deleteError: "Fehler beim Löschen von {name}",
        syncError: "Fehler beim Synchronisieren von {name}",
