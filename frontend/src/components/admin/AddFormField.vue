<template>
  <AddItemButton
    ...
    :dragging="dragging"
    :sortKey="sortKey"
    :dragText="$t('dashboard.dropFormItemHere')"
    :addText="$t('dashboard.clickToAddFormItem')"
    :modalTitle="$t('dashboard.formFields')"
    ...
    return {
      fields: [
        ...
        },
        {
          ...
          type: "textField",
          inputType: "time",
          component: markRaw(Timefield),
        },
        {
          name: this.$t("dashboard.email"),
          type: "textField",
          inputType: "email",
          component: markRaw(Emailfield),
        },
        {
