  ...
  <div class="rounded-lg bg-gray-100 p-2">
    <div v-if="editor" class="flex justify-between">
      <div class="flex flex-col">
        ...
        <div class="flex">
          <EditorButton class="font-bold" @click="editor.chain().focus().toggleBold().run()"
            :active="editor.isActive('bold')">
            Bold
          </EditorButton>
          <EditorButton class="italic" @click="editor.chain().focus().toggleItalic().run()"
            :active="editor.isActive('italic')">
            Italic
          </EditorButton>
          <EditorButton class="line-through" @click="editor.chain().focus().toggleStrike().run()"
