<template>
  ...
  <div class="flex justify-between mb-2">
    <router-link :to="{ name: backLinkTo }">
      <button class="rounded-l-lg bg-white p-1 transition-colors duration-300 ease-in-out hover:bg-gray-400 text-gray-400 hover:text-white">
        <font-awesome-icon :icon="icons.faChevronLeft" class="h-6 w-6 " />
      </button>
    </router-link>
    <div>
      <button v-if="dublicate" @click="dublicateItem" class="bg-white p-1 border-r border-l border-gray-200 transition-colors duration-300 ease-in-out hover:bg-gray-400 text-gray-400 hover:text-white">
        <font-awesome-icon :icon="icons.faCopy" class="h-6 w-6" />
      </button>
      <button v-if="!noDelete" @click="deleteItem" class="bg-white p-1 border-r border-l border-gray-200 transition-colors duration-300 ease-in-out hover:bg-gray-400 text-gray-400 hover:text-white">
        <font-awesome-icon :icon="icons.faTrash" class="h-6 w-6" />
      </button>
      <button class="rounded-r-lg bg-white p-1 transition-colors duration-300 ease-in-out hover:bg-gray-400 text-gray-400 hover:text-white" @click="updateItem">
...
import { faArrowsRotate, faChevronLeft, faTrash, faPlus, faCopy } from "@fortawesome/free-solid-svg-icons";
export default {
  components: {
    Card,
  },
